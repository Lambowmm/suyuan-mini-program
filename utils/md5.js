...
function convertToWordArray(input) {
  ...
  var numberOfWordsTempOne = messageLength + 8;
  var numberOfWordsTempTwo = (numberOfWordsTempOne - (numberOfWordsTempOne % 64)) / 64;
  var numberOfWords = (numberOfWordsTempTwo + 1) * 16;
  var wordArray = [];
  var bytePosition = 0;
  var byteCount = 0;
